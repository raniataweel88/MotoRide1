...
namespace MotoRide.Migrations
{
    ...
    [Migration("20250422164323_deleteimgeinbirthday")]
    partial class deleteimgeinbirthday
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CategoryMaintenanceMaintenance", b =>
                {
                    ...
                    b.HasKey("CategoryMaintenanceId", "MaintenanceId");
            ...
            modelBuilder.Entity("MotoRide.Models.Event", b =>
                {
                    ...
                    b.Property<string>("GovermentNots")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MotoRide.Models.Ticket", b =>
                {
                    ...
                    b.HasOne("MotoRide.Models.User", "User")
                        .WithMany()
